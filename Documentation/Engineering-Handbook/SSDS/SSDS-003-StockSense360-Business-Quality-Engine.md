...
- **Stale data handling:** reuse the existing per-source cache-TTL pattern (no new staleness concept introduced) — fundamentals refresh weekly (`stock_fundamentals_cache`, Product Integrity #009), consistent with the rest of the Selection Engine.
