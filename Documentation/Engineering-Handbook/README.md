...
- **`SSDS/` (StockSense360 System Design Specifications)** — the master architecture document plus templates used to scope work before it's built: [SSDS-000 StockSense360 System Architecture](SSDS/SSDS-000-StockSense360-System-Architecture.md), [SSDS-001 Feature Specification Template](SSDS/SSDS-001-Feature-Specification-Template.md), [SSDS-002 Sprint Specification Template](SSDS/SSDS-002-Sprint-Specification-Template.md).
