...
- **Epic 002 — Financial Strength Intelligence (specification complete, implementation not started):** [SSDS-005 — StockSense360 Financial Strength Intelligence Engine](SSDS/SSDS-005-StockSense360-Financial-Strength-Intelligence-Engine.md) is now the frozen specification — scope boundary vs. Business Quality Intelligence, five scoring categories, the Financial Stress Simulation framework, data requirements, sector-adaptation hypotheses, confidence model, `EngineResponse` mapping, and the validation/sprint roadmap. Formalizes the [Financial Strength Intelligence — Design Study](Architecture/Financial-Strength-Intelligence-Design-Study.md) (the original precursor document; still useful for its narrative reasoning). No code implemented. **Next sprint: a Sprint #006-style data-feasibility study, per market**, resolving the top open question (debt-maturity-split data availability) before any scoring threshold in SSDS-005 is finalized.
